...
def plot(x_label, x_values, y_label, y_values, title="Graph"):
...
def plot_twice(x_label, x_values, y_label, ya_values, yb_values, title="Graph"):
    plt.figure(figsize=(15, 5))
    plt.plot(x_values, ya_values, color='green')
    plt.plot(x_values, yb_values, color='blue')
    plt.xlabel(x_label)
    plt.ylabel(y_label)
    plt.title(title)
    plt.show()
...
def plot_thrice(x_label, x_values, y_label, ya_values, yb_values, yc_values, title="Graph"):
    plt.figure(figsize=(15, 5))
    plt.plot(x_values, ya_values, color='orange')
    plt.plot(x_values, yb_values, color='blue')
    plt.plot(x_values, yc_values, color='red')
    plt.xlabel(x_label)
    plt.ylabel(y_label)
    plt.title(title)
    plt.show()
